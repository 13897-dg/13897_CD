 ...
 * @author cgonc
 */
public class CalculatorServidor extends Thread {
     ...
     */
    public CalculatorServidor(int port) {
        try {
        ...
        if ( this.ss != null ) {
            ...
            for (;;) {
                try {
                    ...
                    CalculatorServidorDedicado dedicado;
                    dedicado = new CalculatorServidorDedicado( s );
                    Thread t = new Thread(dedicado);
                    t.start();                   
                } catch (IOException e) {
